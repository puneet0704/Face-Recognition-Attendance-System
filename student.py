...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\punee\OneDrive\Desktop\face_recognition_system\college_images\student_1.jpg")
        ...
        #secong image
        img1=Image.open(r"C:\Users\punee\OneDrive\Desktop\face_recognition_system\college_images\student_2.jpg")
        ...
        #third image
        img2=Image.open(r"C:\Users\punee\OneDrive\Desktop\face_recognition_system\college_images\student_3.jpg")
        ...
        img_left=Image.open(r"C:\Users\punee\OneDrive\Desktop\face_recognition_system\college_images\sms.jpg")
        img_left=img_left.resize((725,130),Image.ANTIALIAS)
        ...
        course_combo["values"]=("Select Course","FE","TE","BE","SE")
        ...
        img_right=Image.open(r"C:\Users\punee\OneDrive\Desktop\face_recognition_system\college_images\th.jpg")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",user="root",password="Puneet@2002",database="face_recogniser")
    ...
    #    if self.var_roll.get()=="" or self.var_phone.get()=="":
    #        messagebox.showerror("Error","Please select option")
    #    else:
    #        try:
    #            conn=mysql.connector.connect(host="localhost",user="root",password="Puneet@2002",database="face_recogniser")
    #           my_cursor=conn.cursor()
    #           my_cursor.execute("SELECT * FROM student WHERE "+str(self.var_roll.get())+" LIKE '%"+str(self.var_phone.get())+"%'")
    #           data=my_cursor.fetchall()
    #            
    #           if len(data)!=0:
    #               self.student_table.delete(*self.student_table.get_children())
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                #=== Load prdefined data on face frontals from opencv==
